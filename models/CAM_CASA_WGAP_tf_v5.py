...
def network_CAM_CASA_WGAP_tf_v5(cfg):
    ...
    '''
    class CAM_SpatialAttention_CASA_WGAP_tf_v5(backbone):
    ...
    return CAM_SpatialAttention_CASA_WGAP_tf_v5